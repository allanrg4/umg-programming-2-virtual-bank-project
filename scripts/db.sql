...
INSERT INTO `users`
    (`username`, `password`, `first_name`, `last_name`, `first_surname`, `second_surname`, `birthdate`, `gender`, `email_1`, `email_2`, `email_3`, `department`, `municipality`, `postal_code`, `document`, `document_type`, `work_place`, `work_since`, `work_salary`)
VALUES
    ('jdoe', 'password123', 'John', 'Doe', 'Doe', 'Smith', '1985-06-15', 'M', 'jdoe@example.com', 'john.doe@work.com', NULL, 'Engineering', 'Cityville', '12345', '123456789', 'DPI', 'TechCorp', '2010-08-01', 50000.00),
    ('asmith', 'mypassword', 'Alice', 'Smith', 'Smith', 'Johnson', '1990-02-20', 'F', 'asmith@example.com', NULL, NULL, 'HR', 'Townsville', '67890', '987654321', 'PASAPORTE', 'Consulting Inc.', '2015-04-12', 40000.00),
    ('bwayne', 'batman', 'Bruce', 'Wayne', 'Wayne', 'Pennyworth', '1972-04-17', 'M', 'bwayne@wayneindustries.com', 'bruce.wayne@gmail.com', NULL, 'Operations', 'Gotham', '11111', '999999999', 'DPI', 'Wayne Enterprises', '2000-09-30', 1000000.00),
    ('pwalker', 'fast123', 'Paul', 'Walker', 'Walker', 'OConner', '1980-09-12', 'M', 'pwalker@racing.com', NULL, NULL, 'Racing', 'Los Angeles', '54321', '543216789', 'DPI', 'FastCars Inc.', '2012-05-01', 70000.00),
    ('tswift', 'taytay', 'Taylor', 'Swift', 'Swift', 'Alison', '1989-12-13', 'F', 'tswift@music.com', NULL, NULL, 'Music', 'Nashville', '87654', '987654321', 'PASAPORTE', 'Swift Enterprises', '2008-03-05', 150000.00),
    ('rgosling', 'bladerunner', 'Ryan', 'Gosling', 'Gosling', 'Reynolds', '1980-11-12', 'M', 'rgosling@hollywood.com', NULL, NULL, 'Acting', 'Los Angeles', '65432', '654321987', 'DPI', 'Hollywood Films', '2006-08-18', 120000.00),
    ('mwatson', 'hermione', 'Emma', 'Watson', 'Watson', 'Granger', '1990-04-15', 'F', 'mwatson@films.com', NULL, NULL, 'Acting', 'London', '09876', '098761234', 'PASAPORTE', 'British Cinema', '2005-11-10', 90000.00),
    ('clee', 'dragon123', 'Bruce', 'Lee', 'Lee', 'KungFu', '1940-11-27', 'M', 'clee@martialarts.com', NULL, NULL, 'Martial Arts', 'San Francisco', '44556', '777889999', 'DPI', 'Martial Arts School', '1970-01-01', 200000.00),
    ('neil', 'moonman', 'Neil', 'Armstrong', 'Armstrong', 'Aldrin', '1930-08-05', 'M', 'neil@nasa.com', NULL, NULL, 'NASA', 'Houston', '11223', '123654789', 'DPI', 'NASA', '1965-02-20', 180000.00),
    ('elon', 'teslaking', 'Elon', 'Musk', 'Musk', 'Rive', '1971-06-28', 'M', 'elon@tesla.com', 'elon@spacex.com', NULL, 'Technology', 'Palo Alto', '90001', '111222333', 'PASAPORTE', 'SpaceX', '2002-07-15', 500000.00);

INSERT INTO `accounts`
    (`user_id`, `account_number`, `account_type`, `pin`, `notification_sms`, `notification_email`, `online_banking`, `checkbook`)
VALUES
    (1, '001122334455', 'SAVINGS', '1234', TRUE, TRUE, TRUE, FALSE),
...
VALUES
    (1, NULL, 1500.00, 'DEPOSIT', 'Salary Deposit', 'Monthly salary deposit for John Doe.'),
